        ...
        <div className="container mx-auto px-6 lg:px-8 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-blue-50 border border-blue-100 mb-8">
              ...
              <span className="text-xs font-medium text-gray-600 uppercase tracking-wider">Thought Leadership</span>
            </div>
          ...
          <div className="grid lg:grid-cols-2 gap-8 mb-16">
            {featuredInsights.map((insight) => (
              <Link key={insight.slug} href={`/insights/${insight.slug}`} className="group">
                <div className="h-full p-10 rounded-[2.5rem] bg-white border border-gray-200 hover:border-gray-300 hover:shadow-md transition-all duration-300 relative overflow-hidden">
                  <div className="relative z-10 flex flex-col h-full">
                    <div className="flex items-center gap-4 text-sm text-gray-600 mb-6">
                      <span className="px-3 py-1 rounded-full bg-blue-50 border border-blue-100 text-gray-900">
                        {insight.category}
                      </span>
                ...
                <div className="h-full p-8 rounded-3xl bg-white border border-gray-200 hover:border-gray-300 hover:shadow-md transition-all duration-300 relative overflow-hidden">
                  <div className="relative z-10 flex flex-col h-full">
                    <div className="flex items-center gap-4 text-xs text-gray-600 mb-4">
                      <span className="px-2.5 py-0.5 rounded-full bg-blue-50 border border-blue-100 text-gray-900">
                        {insight.category}
                      </span>
                      <span>
                        {new Date(insight.date).toLocaleDateString("en-US", {
                    ...
                    <div className="mt-auto flex items-center text-sm text-blue-600 font-medium group-hover:text-blue-700">
                      Read Article
          ...
          <div className="max-w-3xl mx-auto text-center">
            ...
            <form className="flex flex-col sm:flex-row gap-4 max-w-md mx-auto">
              <input
                ...
                className="flex-1 rounded-full bg-gray-50 border border-gray-200 px-6 py-3 text-gray-900 placeholder:text-gray-400 focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 transition-all"
              />
              <button
                type="button"
                className="rounded-full bg-blue-600 px-8 py-3 text-sm font-semibold text-white hover:bg-blue-700 transition-colors shadow-lg shadow-blue-500/20"
              >
                Subscribe
              </button>
            </form>
