        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 lg:gap-8 mb-16">
          ...
          <div className="lg:col-span-4 space-y-6">
            <Link href="/" className="inline-block">
              <h3 className="text-3xl font-bold text-gray-900 tracking-tight" style={{ fontFamily: "Goglast, sans-serif" }}>
                neuvelabs
              </h3>
            </Link>
          ...
          <div className="lg:col-span-4">
            <h4 className="text-gray-900 font-semibold mb-6">Stay Updated</h4>
            ...
            <form className="flex gap-2">
              <input
                ...
                className="flex-1 bg-gray-50 border border-gray-200 rounded-lg px-4 py-2.5 text-sm text-gray-900 focus:outline-none focus:border-blue-500 transition-colors placeholder:text-gray-400"
              />
              <button
                type="submit"
            ...
            <div className="mt-8 space-y-2">
              <div className="flex items-center gap-3 text-sm text-gray-600">
                ...
                <a href="mailto:info@neuvelabs.com" className="hover:text-gray-900 transition-colors">
                  info@neuvelabs.com
                </a>
              </div>
              <div className="flex items-center gap-3 text-sm text-gray-600">
